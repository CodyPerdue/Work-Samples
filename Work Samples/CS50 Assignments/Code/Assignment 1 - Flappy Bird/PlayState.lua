...
function PlayState:init()
    ...
    self.timer = 0
    self.score = 0
	self.pipeTimer = math.random(1.8, 2.5)
...
function PlayState:update(dt)
	if scrolling == true then
		...
		-- spawn a new pipe pair every few seconds
		if self.timer > self.pipeTimer then
	...
	if love.keyboard.wasPressed('p') then
		-- pause or resume all movement on screen
...
function PlayState:render()
	...
	-- throw up or take away pause image on screen
